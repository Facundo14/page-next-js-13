        ...
        <div className="py-12">
          <div className="container mx-auto px-4">
            ...
            <p className="dark:text-white leading-loose">
              Somos una empresa dedicada al desarrollo de soluciones informáticas innovadoras y a la venta de insumos de alta calidad. Desde nuestro inicio en el año XXXX, nos hemos comprometido en ofrecer a nuestros clientes productos y servicios de la más alta calidad, respaldados por un equipo de profesionales altamente capacitados y comprometidos con su trabajo.
            </p>
