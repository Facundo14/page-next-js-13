        ...
        <section id="servicios" className="py-8 max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <div className="container mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-1 gap-8">
                    <div className="bg-white dark:bg-transparent rounded-lg overflow-hidden transform transition duration-500 hover:scale-105 flex">
                    ...
                    <div className="bg-white dark:bg-transparent rounded-lg overflow-hidden transform transition duration-500 hover:scale-105 flex flex-row-reverse">
